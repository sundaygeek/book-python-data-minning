...
fig1 = sm.graphics.tsa.plot_acf(dta['销量'],lags=10,ax=ax1)
ax2 = fig.add_subplot(212)
fig2 = sm.graphics.tsa.plot_pacf(dta['销量'],lags=10,ax=ax2)
...
datap = np.c_[list(range(1,36)), r[1:], q, p]
...
predict_sunspots[0] += data['2015-02-06':]['销量']
